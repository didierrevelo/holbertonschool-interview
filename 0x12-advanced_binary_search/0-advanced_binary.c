...
/**
 * aux_Binary - searches for a value in a sorted array of integers
 ...
 */
int aux_Binary(int *array, int min, int max, int value)
{
	int mid;
	...
	if (array[mid] >= value)
		return (aux_Binary(array, min, mid, value));
	return (aux_Binary(array, mid + 1, max, value));
}
/**
...
int advanced_binary(int *array, size_t size, int value)
{
	...
	return (aux_Binary(array, 0, size - 1, value));
}
